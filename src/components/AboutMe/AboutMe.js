            ...
            <div className="content-container" id="about-me" ref={aboutMeContainer} /*onClick={onClickHandler} onClick disabled for above*/>
                <div id="about-me-content">
                    ...
                    <div id="socials">
                        ...
                        <a href="https://www.instagram.com/toomuchbob/" className="social-icon-link">
                            <svg height="48" viewBox="0 0 511 511.9" width="48" xmlns="http://www.w3.org/2000/svg">
